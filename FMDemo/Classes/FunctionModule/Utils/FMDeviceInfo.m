...
{
    return [[FMDeviceInfo macaddress] stringByReplacingOccurrencesOfString:@":" withString:@""];
}
...
+ (BOOL)isSimulator
{
    return ([[FMDeviceInfo deviceString] isEqualToString:@"Simulator"]);
}
